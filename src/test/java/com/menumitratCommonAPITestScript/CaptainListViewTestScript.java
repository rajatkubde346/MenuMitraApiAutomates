    ...
    public void captainListViewTest(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            if (apiName.equalsIgnoreCase("captainlistview")) {
                ...
                captainListViewRequest.setOutlet_id(String.valueOf(requestBodyJson.getInt("outlet_id")));
                captainListViewRequest.setUser_id(String.valueOf(requestBodyJson.getInt("user_id")));
                captainListViewRequest.setApp_source(requestBodyJson.getString("app_source"));
