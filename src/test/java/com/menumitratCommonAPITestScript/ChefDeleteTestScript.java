...
import com.menumitra.apiRequest.ChefDeleteRequest;
...
{
    private ChefDeleteRequest chefDeleteRequest;
    ...
    private void setup() throws customException {
        try {
            ...
            chefDeleteRequest = new ChefDeleteRequest();
    ...
    private void deleteChef(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            chefDeleteRequest.setOutlet_id(requestBodyJson.getInt("outlet_id"));
            chefDeleteRequest.setUser_id(requestBodyJson.getInt("user_id"));
            chefDeleteRequest.setUpdate_user_id(user_id);
            chefDeleteRequest.setApp_source(requestBodyJson.getString("app_source"));
