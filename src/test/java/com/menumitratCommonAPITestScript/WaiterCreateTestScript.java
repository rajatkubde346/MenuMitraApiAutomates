    ...
    private void verifyWaiterCreate(String apiName, String testCaseid, String testType, String description,
        ...
        try
        {
            ...
            if(apiName.equalsIgnoreCase("waitercreate"))
            {
                ...
                waiterCreateRequest.setOutlet_id(String.valueOf(requestBodyJson.getInt("outlet_id")));
                ...
                waiterCreateRequest.setApp_source(requestBodyJson.getString("app_source"));
                if (requestBodyJson.has("functionality_ids")) {
                    ...
                    waiterCreateRequest.setFunctionality_ids(functionalityIds);
                }
