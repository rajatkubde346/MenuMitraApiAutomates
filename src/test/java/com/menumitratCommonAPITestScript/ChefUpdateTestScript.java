...
import com.menumitra.apiRequest.ChefUpdateRequest;
...
public class ChefUpdateTestScript extends APIBase {
    private ChefUpdateRequest chefUpdateRequest;
    ...
    private void setup() throws customException {
        try {
            ...
            chefUpdateRequest = new ChefUpdateRequest();
    ...
    private void updateChef(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            chefUpdateRequest.setOutlet_id(requestBodyJson.getString("outlet_id"));
            ...
            chefUpdateRequest.setDob(requestBodyJson.getString("dob"));
            chefUpdateRequest.setEmail(requestBodyJson.getString("email"));
            chefUpdateRequest.setUser_id(requestBodyJson.getInt("user_id"));
            chefUpdateRequest.setApp_source(requestBodyJson.getString("app_source"));
            
            // Convert JSONArray to int array for functionality_ids
            ...
            chefUpdateRequest.setFunctionality_ids(functionalityIds);
            ...
            if (response.getStatusCode() == Integer.parseInt(statusCode)) {
                ...
                ExtentReport.getTest().log(Status.PASS, MarkupHelper.createLabel("Chef updated successfully", ExtentColor.GREEN));
                LogUtils.success(logger, "Chef updated successfully");
            } else {
