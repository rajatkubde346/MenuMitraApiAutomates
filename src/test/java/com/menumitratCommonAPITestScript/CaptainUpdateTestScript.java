    ...
    public void captainUpdateTest(String apiName, String testCaseid, String testType, String description,
        ...
        try {
            ...
            if (apiName.equalsIgnoreCase("captainupdate")) {
                ...
                captainUpdateRequest.setUser_id(String.valueOf(requestBodyJson.getInt("user_id")));
                ...
                captainUpdateRequest.setApp_source(requestBodyJson.getString("app_source"));
                ...
                captainUpdateRequest.setFunctionality_ids(functionalityIds);
